...
from PyQt5.QtWidgets import QTableWidget, QTableWidgetItem, QFileDialog, QAction, \
    QMainWindow  # QToolBar #QStatusBar, QMenuBar
...
PATH_TO_FILE_OF_PRODUCTS = f'D:/OEMTECH/Projects/FILE_STOCK_FOLDER/'  # {FILE_OF_PRODUCTS}'
...
class MyApp(QWidget):
    ...
    def __init__(self,
        ...
        self.report_1_name = 'Report_1'
        self.report_2_name = 'Report_2'
    ...
    # !!!!!!!!!!!!!!!!
    def _column_list(self, bad_balance_report_dict):
        col_moduls_dict = dict([((k + 9), v) for k, v in bad_balance_report_dict.items()])
    ...
    def compose_report_1(self, dict_for_report):
        report_dict, report_df, quantity_min = ReportMaker(dict_for_report, self.modul_df).make_report_1()
    ...
    def compose_report_2(self, dict_for_report):
        ...
        if bad_balance_report_df.empty:
            ...
            cols, col_moduls_dict = self._column_list(bad_balance_report_dict)
            sheet_name = 'СП_плат'
    ...
    def get_report(self):
        ...
        # REPORT WINDOW
        if report_df is not None and report_name:
